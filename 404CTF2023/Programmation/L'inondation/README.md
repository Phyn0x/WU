...
En utilisant la commande netcat fournie, pour rappel : `nc challenges.404ctf.fr 31420` nous voyons qu'on nous demande de compter un certain nombre de fois le pattern correspondant au rhinocéros.
